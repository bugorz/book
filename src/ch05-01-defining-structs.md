...
> ```text
> $ cargo run
>    Compiling no-listing-02-reference-in-struct v0.1.0 (file:///projects/no-listing-02-reference-in-struct)
...
> error: Could not compile `no-listing-02-reference-in-struct`.
>
